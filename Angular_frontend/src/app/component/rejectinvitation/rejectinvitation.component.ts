...
export class RejectinvitationComponent implements OnInit {
  ...
  user:User = new User();
  public user$: any = {};
  constructor(private recommmendationService: RecommendationService ,private loginuserService:LoginuserService , public modalRef: MdbModalRef<RejectinvitationComponent>) { 
  }
  goToPage() {
